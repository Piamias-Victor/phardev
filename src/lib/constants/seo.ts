...
export const SEO_TEMPLATES = {
  home: {
    title: "Phardev - Solutions Innovation Pharmaceutique",
    description:
      "Leader français des solutions digitales pharmaceutiques. Expertise métier + excellence technique pour la transformation digitale de votre officine.",
  },
  projects: {
    title: "Projets Innovation Pharmaceutique | Phardev",
    description:
      "Découvrez nos réalisations : sites vitrines pharmacie, e-commerce, IoT, IA et analytics. Portfolio de solutions digitales pharmaceutiques.",
  },
  team: {
  ...
  contact: {
    ...
    description:
      "Contactez Phardev pour votre projet de transformation digitale pharmaceutique. Conseil gratuit et devis sur mesure.",
  },
} as const
